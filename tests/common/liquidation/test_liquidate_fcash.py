...
def test_liquidate_fcash_local_user_specified_max(liquidation, accounts):
    markets = get_market_curve(3, "flat")
    for m in markets:
        liquidation.setMarketStorage(1, SETTLEMENT_DATE, m)
...
def test_liquidate_fcash_cross_currency_local_available_limit(liquidation, accounts):
    markets = get_market_curve(3, "flat")
    for m in markets:
...
@pytest.mark.skip
def test_liquidate_fcash_cross_currency_collateral_available_limit(liquidation, accounts):
    markets = get_market_curve(3, "flat")
    for m in markets:
        liquidation.setMarketStorage(2, SETTLEMENT_DATE, m)
...
def test_liquidate_fcash_cross_currency_maximum_amount(liquidation, accounts):
    markets = get_market_curve(3, "flat")
    for m in markets:
        liquidation.setMarketStorage(2, SETTLEMENT_DATE, m)
...
def test_liquidate_fcash_cross_currency_user_specified_maximum(liquidation, accounts):
    markets = get_market_curve(3, "flat")
    for m in markets:
        liquidation.setMarketStorage(2, SETTLEMENT_DATE, m)
