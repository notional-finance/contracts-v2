...
@pytest.fixture(scope="module", autouse=True)
def liquidation(MockCollateralLiquidation, MockCToken, cTokenAggregator, ethAggregators, accounts):
...
def test_over_max_collateral_amount(liquidation, accounts):
...
def test_limited_by_max_collateral_amount(liquidation, accounts):
...
def test_limited_by_user_specification(liquidation, accounts):
...
def test_limited_by_collateral_cash_balance(liquidation, accounts):
...
def test_limited_by_collateral_available(liquidation, accounts):
...
def test_limited_by_local_available(liquidation, accounts):
...
def test_ntokens_suffcient_amount(liquidation, accounts):
...
def test_ntokens_limited_by_collateral_specification(liquidation, accounts):
    # Liquidate part of ntokens up to what is required
    cashBalance = 0
    nTokenBalance = 1000e8
    nTokenValue = 900e8  # This is haircut at 90%
...
def test_ntokens_limited_by_ntoken_specification(liquidation, accounts):
    # Liquidate part of ntokens up to what is required
    cashBalance = 0
    nTokenBalance = 1000e8
    nTokenValue = 900e8  # This is haircut at 90%
...
def test_ntokens_limited_by_balance(liquidation, accounts):
    # Liquidate part of ntokens up to what is required
    cashBalance = 0
    nTokenBalance = 100e8
...
def test_ntokens_limited_max_collateral_allowed(liquidation, accounts):
    # Liquidate part of ntokens up to what is required
    cashBalance = 0
    nTokenBalance = 1000e8
    nTokenValue = 900e8  # This is haircut at 90%
...
def test_sufficient_withdraw_liquidity_tokens(liquidation, accounts):
    localBalance = -100e8
...
def test_not_sufficient_withdraw_liquidity_tokens(liquidation, accounts):
    liquidityTokenNotional = 100e8
