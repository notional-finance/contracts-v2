...
certoraRun contracts/external/actions/${contract}.sol \
	...
	--msg "Notional - ${contract} counting - modified portfolio handler" --cache Notional5${contract} --optimistic_loop --settings "-enableEqualitySaturation=false,-s=cvc4,-adaptiveSolverConfig=false,-depth=10,-copyLoopUnroll=4,-t=100" --javaArgs '"-Dcvt.default.parallelism=6 -Dverbose.times"' --solc solc7.6
